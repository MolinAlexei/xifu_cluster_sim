from xifu_cluster_sim.mosaic import Mosaic
...
parser.add_argument("--cluster_file", 
	type = str, 
	help = "Path to the cluster file to load, if any", 
	default = None)
...
mosaic.run_mosaic(args.x_offsets,
	args.y_offsets,
	args.pointing_names,
	skip_photon_list = args.skip_photon_list)